 ...
 */
final class Version20200529064011 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE refuel ADD creator_user VARCHAR(255) NOT NULL, ADD modifier_user VARCHAR(255) DEFAULT NULL, DROP creator_user_id, DROP modifier_user_id, CHANGE code_driver code_driver VARCHAR(255) DEFAULT NULL, CHANGE modification_date modification_date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE refresh_token CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE refuel ADD creator_user_id INT DEFAULT NULL, ADD modifier_user_id INT DEFAULT NULL, DROP creator_user, DROP modifier_user, CHANGE code_driver code_driver VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE modification_date modification_date DATETIME NOT NULL');
