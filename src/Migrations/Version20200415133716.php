 ...
 */
final class Version20200415133716 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE integrationmodel (id INT AUTO_INCREMENT NOT NULL, system_id INT NOT NULL, volumelocation VARCHAR(255) NOT NULL, datelocation VARCHAR(255) NOT NULL, dateformatlocation VARCHAR(255) NOT NULL, codetrucklocation VARCHAR(255) NOT NULL, codedriverlocation VARCHAR(255) DEFAULT NULL, mileagetrucklocation VARCHAR(255) NOT NULL, INDEX IDX_BF2E3FD9D0952FA5 (system_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, homeagency_id INT DEFAULT NULL, login VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649AA08CB10 (login), INDEX IDX_8D93D649862F6747 (homeagency_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE homeagency_integrationmodel DROP FOREIGN KEY FK_C5394F06011ECC3');
