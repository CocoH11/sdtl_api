 ...
 */
final class Version20200421081641 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE truck CHANGE numberplate numberplate VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE refuel CHANGE driver_id driver_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE truck CHANGE numberplate numberplate INT NOT NULL');
